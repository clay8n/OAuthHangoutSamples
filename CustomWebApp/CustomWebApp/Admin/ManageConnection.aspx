<%@ Page Title="Admin Area" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageConnection.aspx.cs" Inherits="CustomWebApp.ManageConnection" %>

<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    <hgroup class="title">
        <h1><%: Title %>.</h1>
        <h2>Manage QuickBooks Connection.</h2>
    </hgroup>
    <p class="message-info">
        Connect or disconnect access for this Intranet application.
    </p>
    <article>
